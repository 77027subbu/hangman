...
public class Index {
    ...
    private int getScore(String _char){
        ...
        switch(CharUtils.toChar(_char.toUpperCase())) {
            case 'A' : _score=1; break;
            case 'B' : _score=3; break;
            case 'C' : _score=3; break;
            case 'D' : _score=2; break;
            case 'E' : _score=1; break;
            case 'F' : _score=4; break;
            case 'G' : _score=1; break;
            case 'H' : _score=4; break;
            case 'I' : _score=1; break;
            case 'J' : _score=8; break;
            case 'K' : _score=5; break;
            case 'L' : _score=1; break;
            case 'M' : _score=3; break;
            case 'N' : _score=1; break;
            case 'O' : _score=1; break;
            case 'P' : _score=3; break;
            case 'Q' : _score=10; break;
            case 'R' : _score=1; break;
            case 'S' : _score=1; break;
            case 'T' : _score=1; break;
            case 'U' : _score=1; break;
            case 'V' : _score=4; break;
            case 'W' : _score=4; break;
            case 'X' : _score=8; break;
            case 'Y' : _score=4; break;
            case 'Z' : _score=10; break;
        }
        return _score;
    }
}